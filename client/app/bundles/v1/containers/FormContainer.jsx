...
function FormContainer(props){
  const { displayNewProfile, displayEditProfile, createProfile, updateForm } = props;
  return (
    <div>
      <NewProfileForm visible={displayNewProfile.isVisible} createProfile={createProfile} updateForm={updateForm} />
      <EditProfile visible={displayEditProfile.isVisible} createProfile={createProfile} updateForm={updateForm} />
    </div>
  );
}
